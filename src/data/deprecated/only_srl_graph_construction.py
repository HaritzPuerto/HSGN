...
training_path = os.path.join(data_path, 'processed/training/heterog_20200822_only_srl')
...
dev_path = os.path.join(data_path, 'processed/dev/heterog_20200822_only_srl/')
