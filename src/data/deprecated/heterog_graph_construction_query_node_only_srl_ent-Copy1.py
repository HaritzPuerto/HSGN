...
training_path = os.path.join(data_path, 'processed/training/heterog_20200827_nohierachchy')
...
dev_path = os.path.join(data_path, 'processed/dev/heterog_20200827_nohierachchy')
