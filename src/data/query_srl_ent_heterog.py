...
train_dataset = Dataset(hotpot_train[0:400], list_hotpot_train_ner, dict_ins_doc_sent_srl_triples,
...
training_path = os.path.join(data_path, 'processed/training/heterog_20200828_query_srl_ent')
...
dev_path = os.path.join(data_path, 'processed/dev/heterog_20200828_query_srl_ent')
