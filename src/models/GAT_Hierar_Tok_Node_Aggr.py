...
#         # graph_emb shape [num_nodes, in_feats]
        ...
        return ({'sent': {'loss': loss_sent, 'probs': probs_sent, 'logits': logits_sent, 
                          'emb': sent_emb, 'lbl': sent_labels, 'sample_nodes': sample_sent_nodes},
...
# %%
model_path = 'models/ans_type_pred_double_span_pred'

best_eval_em = 0
# Measure the total training time for the whole run.
total_t0 = time.time()
with neptune.create_experiment(name="answer type pred + srl masking in logits ", params=PARAMS, upload_source_files=['src/models/GAT_Hierar_Tok_Node_Aggr.py']):
